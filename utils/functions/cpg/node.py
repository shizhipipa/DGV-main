...
node_labels = ['Block', 'Call', 'Comment', 'ControlStructure', 'File', 'Identifier', 'FieldIdentifier', 'JumpTarget', 'Literal', 'Local', 'Member', 'MetaData', 'Method', 'MethodInst', 'MethodParameterIn', 'MethodParameterOut', 'MethodReturn', 'Namespace', 'NamespaceBlock', 'Return', 'Type', 'TypeDecl', 'Unknown']
operators = ['addition', 'addressOf', 'and', 'arithmeticShiftRight', 'assignment', 'assignmentAnd', 'assignmentArithmeticShiftRight', 'assignmentDivision', 'assignmentMinus', 'assignmentMultiplication', 'assignmentOr', 'assignmentPlus', 'assignmentShiftLeft', 'assignmentXor', 'cast', 'conditionalExpression', 'delete', 'division', 'equals', 'fieldAccess', 'greaterEqualsThan', 'greaterThan', 'indirectFieldAccess', 'indirectIndexAccess', 'indirection', 'lessEqualsThan', 'lessThan', 'logicalAnd', 'logicalNot', 'logicalOr', 'minus', 'modulo', 'multiplication', 'new', 'not', 'notEquals', 'or', 'postDecrement', 'plus', 'postIncrement', 'preDecrement', 'preIncrement', 'shiftLeft', 'sizeOf', 'subtraction']
